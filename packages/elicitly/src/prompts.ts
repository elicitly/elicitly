...
export const contributeFingerprintPrompt = {
  ...
  text: [
    ...
    "   ask how this server is attached — a config-file command (like npx) or a desktop",
    "   extension (MCPB) install — so the contribution records which path was measured, and",
    "   whether anything about the setup is unusual (OS, flags, enterprise policy) — that",
    ...
    "     **Attached via:** <config-file command (e.g. npx) or desktop extension (MCPB), per the user>",
